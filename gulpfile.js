...
gulp.task('scripts:main', function() {
    gulp.src(['app/js/idb.js', 'app/js/dbhelper.js', 'app/js/main.js', 'app/js/focus-visible.js'])
        .pipe(babel({
            presets: ['env']
        }))
...
gulp.task('scripts:restaurant', function() {
    gulp.src(['app/js/idb.js', 'app/js/dbhelper.js', 'app/js/restaurant_info.js', 'app/js/focus-visible.js'])
        .pipe(babel({
            presets: ['env']
        }))
        .pipe(sourcemaps.init())
